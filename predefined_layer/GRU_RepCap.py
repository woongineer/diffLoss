...
if __name__ == "__main__":
    ...
    plot_fidelity_loss(last_fidelity_loss_list, 'GRU_RepCap_loss.png')
    save_probability_animation(prob_list, "GRU_RepCap_loss_animation.mp4")
    save_trajectory(layer_list_list, filename="GRU_RepCap_loss_trajectory.png", max_epoch_PG=max_episode,
                    num_layer=num_layer)
    print(datetime.now())
